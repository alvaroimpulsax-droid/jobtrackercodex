  ...
  return (
    <div className="fade-in">
      ...
      <section className={styles.panel}>
        <h2 className={styles.topbarTitle}>Configuración</h2>
        <div className={styles.cards}>
      ...
      <section className={styles.grid}>
        <div className={styles.panel}>
          <h2 className={styles.topbarTitle}>Últimas 24h</h2>
      ...
      <section className={styles.panel}>
        ...
        <p className={styles.topbarMeta}>Solo se muestran si hay URL pública configurada.</p>
        <div className={styles.cards}>
          {screenshots.slice(0, 6).map((shot) => (
            <div key={shot.id} className={styles.card}>
              ...
              {shot.url ? (
                ...
                <div className={styles.topbarMeta}>Sin URL pública</div>
              )}
            </div>
          ))}
